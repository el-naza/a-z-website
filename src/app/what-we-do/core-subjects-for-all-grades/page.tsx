...
export default function CoreSubjectsForAllGrades() {
  return (
    <>
      ...
      <ul>
        <li>
          Grasp fundamental concepts in the early grades.
          <br />
          <br />
        </li>
        <li>
          Build upon prior knowledge and develop critical thinking skills in
          middle school.
          <br />
          <br />
        </li>
        <li>
          Prepare for standardized tests and higher-level coursework in high
          school.
        </li>
      </ul>
      <br />
      ...
      <br />
      <br />
      Contact us today to learn more about our core subject tutoring programs!
      We offer personalized tutoring plans that fit your child's specific needs
      and grade level.
    </>
  );
}
