...
export default function OneOnOneHomeTutoring() {
  return (
    <>
      ...
      <ul>
        <li>
          <strong>Expert Tutors: </strong>Our team comprises highly qualified
          and experienced educators specializing in each exam format. They stay
          up-to-date on the latest exam trends and offer personalized guidance
        ...
        <li>
          <strong>Targeted Instruction: </strong>We go beyond generic
          test-taking strategies. Our customized programs focus on the specific
          content and skills tested in each exam.
          <br />
          <br />
        </li>
        <li>
          <strong>Flexible Learning Options: </strong>Choose from online or
          in-person tutoring to fit your learning style and schedule.
          <br />
          <br />
        </li>
      </ul>
