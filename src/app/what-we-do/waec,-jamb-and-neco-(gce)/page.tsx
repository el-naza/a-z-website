...
export default function OneOnOneHomeTutoring() {
  return (
    <>
      Stressed about standardized exams? Don't let exam anxiety hold your child
      back from achieving their academic goals. At A-Z New Age Tutors, we offer
      comprehensive exam preparation lessons for a variety of Nigerian secondary
      school examinations:
      <br />
      <br />
      <ul>
        ...
        <li>
          <strong>NECO (National Examinations Council): </strong>We can equip
          your child with the knowledge and skills they need to succeed on their
          NECO exams, including the SSCE (Senior School Certificate
          Examination).
          <br />
          <br />
        </li>
      ...
      <ul>
        ...
        <li>
          <strong>Targeted Practice: </strong>Through practice tests, past exam
          questions, and focused revision techniques, we ensure your child is
          well-prepared for the specific format and content of each exam.
          <br />
          <br />
        </li>
        <li>
      ...
      achieve their exam goals and gain entry into their desired program of
      study.
      <br />
      <br />
