...
export default function Home() {
  return (
      <>
        <section
            className="max-w-[1112px] m-auto mt-[28px] md:mt-[56px] md:mb-[183.44px] mb-[67.4px] md:justify-between md:items-end items-center flex max-md:flex-col justify-center ">
        ...
        <section
            className="relative flex max-md:flex-col gap-[30px] md:gap-[82px] md:pl-[150px] py-[94px] md:pt-[200px] md:pb-[170px] md:pr-[80px] items-center md:overflow-hidden">
          ...
          <div
              className="relative rounded-[10px] max-w-[617px] py-[42px] pl-[30px] md:bg-gray-blue bg-[#FEFEFED1] flex gap-[23px] md:overflow-visible w-[calc(100%_+_38px)] overflow-scroll items-center self-start max-md:shadow-sm">
            <TestimonialCard
            ...
            <div
                className="absolute right-[15px] bg-primary2 max-w-[60px] aspect-square rounded-full flex items-center justify-center max-md:hidden">
