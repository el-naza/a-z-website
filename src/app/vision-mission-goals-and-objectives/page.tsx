    ...
    <>
      ...
      <section className="flex max-md:flex-wrap gap-[71px] mb-[80px] max-w-[1024px] m-auto items-center">
        <div className="max-md:text-[16px] flex flex-col gap-[20px]">
          ...
          supportive and inclusive learning environment that empowers learners
      ...
      <section className="flex max-md:flex-wrap gap-[71px] mb-[80px] max-w-[1024px] m-auto items-center">
        ...
        <div className="max-md:text-[16px] flex flex-col gap-[20px]">
          ...
          <br />
          <span>
            2. To build a team of highly qualified, passionate, and dedicated
            tutors committed to delivering exceptional results.
          </span>
          <span>
            3. To establish a reputation as a trusted, innovative, and
            customer-focused tutoring agency.
          </span>
          <span>
            4. To continuously improve and expand our services to meet the
            evolving needs of our learners and the community.
          </span>
        </div>
      </section>
      ...
      <section className="flex max-md:flex-wrap gap-[71px] mb-[80px] max-w-[1024px] m-auto items-center">
        <div className="max-md:text-[16px] flex flex-col gap-[20px]">
          ...
          <br />
          <span>
            2. To develop a growth mindset in learners, promoting resilience,
            persistence, and a love for learning.
          </span>
          <span>
            3. To empower learners to take ownership of their learning, setting
            goals and developing strategies for success.
          </span>
          <span>
            4. To provide ongoing support and resources for learners, parents,
            and tutors, ensuring a collaborative approach to learning.
          </span>
          <span>
            5. To promote inclusivity, diversity, and equity, ensuring every
            learner feels valued, respected, and supported.
          </span>
        </div>
        <Image
          className=""
      ...
      <section className="flex max-md:flex-wrap gap-[71px] mb-[80px] max-w-[1024px] m-auto items-center">
        <div className="max-md:text-[16px] flex flex-col gap-[20px]">
          ...
          <br />
          <span>
            2. To maintain a 95% client satisfaction rate, as measured through
            regular feedback and evaluations.
          </span>
          <span>
            3. To expand our tutoring services to reach a minimum of 750
            learners within the first 5 years of operation.
          </span>
          <span>
            4. To establish partnerships with local schools, educational
            institutions, and community organizations to provide tutoring
            services to underserved populations.
          </span>
          <span>
            5. To develop and implement a comprehensive training program for
            tutors, ensuring ongoing professional development and excellence.
          </span>
          <span>
            6. To create a learner ambassador program, empowering learners to
            share their experiences and inspire others.
          </span>
          <span>
            7. To develop strategic partnerships with educational technology
            companies to enhance our services and stay at the forefront of
            innovation.
          </span>
        </div>
        <Image
