  ...
  return (
    <>
      <div
        {...props}
        className={cn(
          "group relative flex h-full w-full overflow-hidden p-2 [--duration:20s] [--gap:12px] [gap:var(--gap)]",
          {
            "flex-col": vertical,
            "flex-row": !vertical,
          },
      ...
      {applyMask && (
        <div
          className={cn("pointer-events-none absolute z-10 h-full w-full", {
            "bg-gradient-to-b from-white/50 from-5% via-transparent via-50% to-white/50 to-35% dark:from-black/10 dark:to-black/10":
              vertical,
            "bg-gradient-to-r from-white/50 from-5% via-transparent via-50% to-white/50 to-35% dark:from-black/10 dark:to-black/10":
              !vertical,
          })}
        />
      )}
