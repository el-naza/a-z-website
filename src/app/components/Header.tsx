  ...
  function NavLink({
    ...
    return (
      <Link
        ...
        } hover:text-black max-md:text-[16px] max-md:leading-[19.2px] z-20 `}
        {...props}
      >
        {children}
        {/* {isActive && (
    ...
    <header className="h-[102px] max-md:h-[58px]">
      ...
      <div className="px-[35px] max-md:py-1 fixed w-[100%] py-[10px] border-b-2 border-gray2 bg-white z-10">
        <div className="flex justify-between items-center max-w-[1116px] m-auto">
          ...
          />
          <nav className="flex gap-[50px] text-[20px] leading-[24px] max-md:hidden items-center">
            <NavLink href="/">Home</NavLink>
            <div className="group relative cursor-pointer">
              <Link href="/our-services">
                <span className="text-gray hover:text-black">What we do</span>
              </Link>
              <div className="absolute invisible flex flex-wrap w-[804px] bg-white p-[18px] rounded-[16px] left-[-13px]  gap-y-[8px] justify-between group-hover:visible hover:visible z-50 shadow-[0px_0px_30px_0px_#0000001A]">
                ...
                <WhatWeDoMenuItem title="Standardized Exams" />
