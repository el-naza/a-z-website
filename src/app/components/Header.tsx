          ...
          <div className="flex justify-between items-center max-w-[1116px] m-auto">
            ...
            <nav className="flex gap-[50px] text-[20px] leading-[24px] max-md:hidden">
              ...
              <div className="group relative cursor-pointer">
                ...
                <div
                    className="absolute invisible flex flex-wrap w-[804px] bg-white p-[18px] rounded-[16px] left-[-13px]  gap-y-[12px] justify-between group-hover:visible hover:visible shadow-[0px_0px_30px_0px_#0000001A]">
